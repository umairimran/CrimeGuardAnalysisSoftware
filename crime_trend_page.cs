...
namespace crime_trend_project_winforms_latest
{
            ...
            chart.Series = new LiveCharts.SeriesCollection
    {
        ...
        public void generateDynamicUserControls()
        {
            ...
            List<UserControl1> listItems = new List<UserControl1>(); string connectionString = "Data Source=C:\\Users\\LENOVO\\source\\repos\\CrimeGuardAnalysisSoftware\\crime_db.db";
